...
function cubehype_scripts() {
	...
	wp_enqueue_style( 'cubehype-style', get_template_directory_uri().'/assets/css/stylesheet.min.css', array(), '1.0.9', 'all');
	...
	wp_enqueue_script( 'cubehype-script', get_template_directory_uri(). '/assets/js/script.min.js', array('jquery'), '1.0.2', true);
